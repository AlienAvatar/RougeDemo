...
UObject* URougeAssetManager::SynchronousLoadAsset(const FSoftObjectPath& AssetPath)
{
...
bool URougeAssetManager::ShouldLogAssetLoads()
{
	static bool bLogAssetLoads = FParse::Param(FCommandLine::Get(), TEXT("LogAssetLoads"));
	return bLogAssetLoads;
}

void URougeAssetManager::AddLoadedAsset(const UObject* Asset)
{
